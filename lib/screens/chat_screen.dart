...
import 'package:application_unknown/widgets/user_two_reply.dart';
...
class _ChatScreenState extends State<ChatScreen>
  ...
  functionShowReplyTextField(String msg, String index,String user) {
    setState(() {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              if (ds["type"] == "text" && ds["reply"] == null) {
                ...
                return _auth.currentUser.uid == ds["sentBy"]?
                UserOneReply(message: ds["reply"], reply: ds["message"],userName: ds["userName"]):
                UserTwoReply(message: ds["reply"],reply: ds["message"],userName: ds["userName"],);
              } else if (ds["type"] == "doc") {
                return _auth.currentUser.uid == ds["sentBy"]
                    ? Document(
